...
public class ProductControllerRA {
	...
	@Test
	public void findAAllShouldReturnPageProductsWhenProductNameIsEmpty() {
	...
	@Test
	public void findAAllShouldReturnPageProductsWhenProductNameIsNotEmpty() {
	...
	@Test
	public void findAAllShouldReturnPageProductsWithPriceGreaterThan2000() {
	...
	JSONObject newProduct = new JSONObject(postProductInstance);
		...
		.then()
			.statusCode(422)
			.body("errors.message[0]", equalTo("Deve conter pelo menos uma categoria"));
